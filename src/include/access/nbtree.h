...
extern bool _bt_parallel_done(IndexScanDesc scan, BTScanState state);
 ...
 */
extern bool _bt_readpage(IndexScanDesc scan, BTScanState state,
...
/*
 * for both nbtpreprocesskeys.c and nbtreadpage.c
 */
