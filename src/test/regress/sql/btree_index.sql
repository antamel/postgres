...
-- equidistance elements come first
SELECT * FROM simple_knn_test WHERE a IN (2,4,5,2) ORDER BY a <-> 3;

-- equidistance elements come last
SELECT * FROM simple_knn_test WHERE a IN (1,4,5,1) ORDER BY a <-> 3;

-- equidistance elements are in the middle
SELECT * FROM simple_knn_test WHERE a IN (2,4,5,2,3) ORDER BY a <-> 3;

-- corner cases
SELECT * FROM simple_knn_test WHERE a IN (2,2) ORDER BY a <-> 3;
SELECT * FROM simple_knn_test WHERE a IN (2,2,5,5) ORDER BY a <-> 3;
SELECT * FROM simple_knn_test WHERE a IN (5,5,2,2,5,5) ORDER BY a <-> 3;
...
-- test of the contradictory array elements removing

EXPLAIN (COSTS OFF)
SELECT * FROM simple_knn_test WHERE a IN (1, 2, 3) AND a < 2 ORDER BY a <-> 2;
...
EXPLAIN (COSTS OFF)
SELECT * FROM simple_knn_test WHERE a IN (1, 3) AND a = 2 ORDER BY a <-> 2;

SELECT * FROM simple_knn_test WHERE a IN (1, 3) AND a = 2 ORDER BY a <-> 2;

SELECT * FROM simple_knn_test WHERE a IN (1, 3, 2) AND a = 2 ORDER BY a <-> 2;

DROP TABLE simple_knn_test CASCADE;
CREATE TABLE cross_knn_test (id serial, value bigint);
INSERT INTO cross_knn_test (value) SELECT generate_series(-100000, 100000, 10);
CREATE INDEX cross_knn_test_idx ON cross_knn_test USING btree(value);

-- cross-type tests:

EXPLAIN (COSTS OFF)
SELECT value FROM cross_knn_test WHERE value = ANY ('{-32760, 0, 32760}'::int8[]) ORDER BY value <-> 32761::int2;

SELECT value FROM cross_knn_test WHERE value = ANY ('{-32760, 0, 32760}'::int8[]) ORDER BY value <-> 32761::int2;

SELECT value FROM cross_knn_test WHERE value = ANY ('{-32760, 0, 32760}'::int2[]) ORDER BY value <-> 32761::int8;

SELECT value FROM cross_knn_test WHERE value = ANY ('{-32760, 0, 32760}'::int8[]) ORDER BY value <-> -32761::int2;

SELECT value FROM cross_knn_test WHERE value = ANY ('{-32760, 0, 32760}'::int2[]) ORDER BY value <-> -32761::int8;

SELECT value FROM cross_knn_test WHERE value = ANY ('{-32760, 0, 32760}'::int2[])  ORDER BY value <-> 1::int8;

SELECT value FROM cross_knn_test WHERE value = ANY ('{-32760, 0, 32760}'::int8[])  ORDER BY value <-> 1::int2;

DROP TABLE cross_knn_test CASCADE;
RESET enable_seqscan;
